...
<body>
    <div class="content">
        ...
        <div class="separate-line"
            style="border-top: 1px dashed #000;height: 1px;margin-bottom: 5px"></div>
            ...
            <table class="transaction-table"
                ...
                @foreach ($transaction->details()->get() as $item)
                    <tr>
                        ...
                        <td class='qty'
                            style='text-align: center'>{{ $item->qty }}</td>
                        <td class='final-price'
                            style='text-align: right'
                            colspan="5">{{ rupiahFormat($item->price) }}</td>
                    </tr>
                @endforeach
                <tr class="price-tr">
                    <td colspan="3">
                ...
                <tr>
                    ...
                    <td class="final-price">
                        {{ rupiahFormat($transaction->grand_total) }}
                    </td>
                </tr>
                <tr>
                    <td colspan="3"
                    ...
                    <td class="final-price">
                        {{ rupiahFormat($transaction->discount) }}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="final-price">
                        {{ rupiahFormat($transaction->change) }}
                    </td>
                </tr>
            </table>
        </div>

...
@section('content')
    <div id="controller">
        <div class="card border-0 rounded-3 shadow border-top-purple">
            <div class="card-header"><span class="font-weight-bold"><i class="fa fa-chart-bar"></i> REPORT PROFITS</span></div>
            <div class="card-body">
                <form>
                    <div class="row">
                        <div class="col-md-5">
                ...
                <div class="export text-end mb-3">
                    <a href="/apps/profits/export?start_date={{ @$_GET['start_date'] }}&end_date={{ @$_GET['end_date'] }}"
                        class="btn btn-success btn-md border-0 shadow me-3"><i class="fa fa-file-excel"></i> EXCEL</a>
                    <a href="/apps/profits/pdf?start_date={{ @$_GET['start_date'] }}&end_date={{ @$_GET['end_date'] }}"
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        @forelse ($profits as $profit)
                            <tr>
                                <td>{{ formatTanggalIndoWithTime($profit->created_at) }}</td>
                                <td class="text-center">{{ $profit->transaction->invoice }}</td>
                                <td class="text-end">Rp. {{ rupiahFormat($profit->total) }}</td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="3">
